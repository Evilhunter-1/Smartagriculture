...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('${process.env.REACT_APP_API_URL || "http://localhost:5000"}/api/auth/register', formData);
